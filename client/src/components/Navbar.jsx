  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Desktop: show nav links and right side, hide hamburger */
            ...
            {modeOpen && (
              <div style={{
                ...
                >
                  ...
                  <div>
                    <div>Light Mode</div>
                    <div style={{ fontSize: "11px", color: !darkMode ? "var(--green-600)" : "var(--text-muted)", marginTop: "1px" }}>
                      Clean white theme
                    </div>
                  </div>
            ...
            <div ref={dropdownRef} style={{ position: "relative" }}>
              ...
              {dropdown && (
                <div style={{
                  ...
                  minWidth: "210px", overflow: "hidden", zIndex: 200,
                  animation: "fadeSlideDown 0.15s ease",
                }}>
                  ...
                  {[
                    ...
                    ...(user.role === "admin"
                      ? [
                          ...
                          { label: "🗺️ Manage Tours",    path: "/admin/tours" },
                        ]
                      : []),
                  ].map((item) => (
                    <Link
